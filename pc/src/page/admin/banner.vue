                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button
                            ...
                            plain 
                            size="small"
                            @click.native.prevent="updateRow(scope.row.id, 0)">禁用</el-button>
                        <el-button
                            type="success"
                            plain 
                            size="small"
                            @click.native.prevent="updateRow(scope.row.id, 1)">开启</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        <!-- 图片预览框 -->
        <div v-if="dialogVisible" class="preview-img-bg" @click="closedHideBg">
